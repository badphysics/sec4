...
\pagestyle{head}
\firstpageheader{ \Large{Name:}}{\Large{Quiz 3}}{}
...
\begin{parts}
\part[4] $\displaystyle \frac{x-1}{x+2}-\frac{x+3}{x-4}$
  \vfill

\part[4] $\displaystyle \frac{y^2-16}{2y+6} + \frac{y+3}{y-4}$ 
\vfill

\part[7] $\displaystyle \frac{1}{x-1}-\frac{2}{x+1}\div\frac{x^2-1}{3x +1}$
\vfill
\end{parts}
